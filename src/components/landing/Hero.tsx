        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <motion.div
              ...
              className="inline-flex items-center gap-2 text-xs font-black text-[#4582ff] uppercase tracking-widest"
            >
              <span className="w-1.5 h-1.5 bg-[#4582ff] inline-block rounded-xs" />
              J&K HIGHER EDUCATION GUIDANCE SYSTEM
            </motion.div>

            <h1 className="font-display font-black text-4xl md:text-6xl lg:text-7xl leading-[1.1] text-[#0f2239] tracking-tight">
              Not sure what to{" "}
            ...
            <motion.p
              ...
              className="text-sm md:text-base text-[#636363] leading-relaxed max-w-xl"
            >
            ...
            >
              <Link to="/dashboard/profile">
                <ShinyButton className="text-sm px-8 py-4 font-black uppercase tracking-wider shadow-xl hover:shadow-2xl">
              ...
              <a
                href="#how-it-works"
                className="flex items-center gap-3 text-sm font-extrabold text-[#0f2239] group"
              >
                <span className="w-10 h-10 rounded-full bg-[#0f2239] text-white flex items-center justify-center group-hover:bg-[#4582ff] transition-all shadow-md">
                  ↓
                </span>
          ...
          {/* Right Column: Exploration First Card (Matching Image 3) */}
          <div className="lg:col-span-5 flex justify-center items-center relative py-6">
            ...
            <motion.div
              ...
              className="relative p-8 bg-white rounded-3xl border border-slate-200/80 shadow-2xl flex flex-col items-center text-center space-y-5 max-w-[300px] w-full"
            >
